...
#ifndef HPP_CORE_PARABOLA_PATH_HH
# define HPP_CORE_PARABOLA_PATH_HH
...
namespace hpp {
  namespace core {
    ...
    class HPP_CORE_DLLAPI ParabolaPath : public Path
    {
    public:
      ...
      static ParabolaPathPtr_t create (const DevicePtr_t& device,
	...
	(const ParabolaPathPtr_t& path, const ConstraintSetPtr_t& constraints)
      {
	...
	return os;
      ...
      /// Constructor
      ParabolaPath (const DevicePtr_t& robot, ConfigurationIn_t init,
